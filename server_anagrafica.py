...
# definisci la funzione per eseguire una query sul database
def run_query(query):
...
# definisci la funzione per gestire le richieste del client
...
# definisci la funzione per avviare il server
def start_server():
